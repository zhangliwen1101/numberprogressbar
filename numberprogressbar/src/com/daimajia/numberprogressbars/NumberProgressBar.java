package com.daimajia.numberprogressbars;
...
import static com.daimajia.numberprogressbars.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.daimajia.numberprogressbars.NumberProgressBar.ProgressTextVisibility.Visible;
...
public class NumberProgressBar extends View {
	...
	private Paint mText;
	private float mtextpinng;
	private float mtextEndpinng;
	...
	protected void onDraw(Canvas canvas) {
		...
		// canvas.drawText("¾Á²ÆÍ¨", mtextpinng+50f, mDrawTextEnd, mText);
	}
	...
	private void calculateDrawRectF() {
		...
		mCurrentDrawText = String.valueOf((double) getProgress() * 100 / 1000);

		mCurrentDrawText = mPrefix + mCurrentDrawText + mSuffix;
		mDrawTextWidth = mTextPaint.measureText(mCurrentDrawText);
		Log.i("mReachedRectF", "mReachedRectF.right :" + mReachedRectF.right
				+ "mOffset: " + mOffset);
		if (getProgress() == 0) {
